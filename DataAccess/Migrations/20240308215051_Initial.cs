        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalEffectivePayment = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EffectiveInitialPayment = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DeferredInitialPayment = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DeferredInitialPaymentTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    CreditSalesTerm = table.Column<int>(type: "int", nullable: false),
                    StatedPriceCharged = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalSalesAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NetAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BaseAmountForCommission = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PaymentMethodId = table.Column<int>(type: "int", nullable: false),
                    StateId = table.Column<int>(type: "int", nullable: false),
                    Commission = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    RangeId = table.Column<int>(type: "int", nullable: false),
                    AuthsAndObservations = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contracts_Ranges_RangeId",
                        column: x => x.RangeId,
                        principalTable: "Ranges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contracts_States_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_RangeId",
                table: "Contracts",
                column: "RangeId");

            migrationBuilder.CreateIndex(
                name: "IX_Contracts_StateId",
                table: "Contracts",
                column: "StateId");
